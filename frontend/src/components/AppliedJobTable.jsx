...
const AppliedJobTable = () => {
  ...
  return (
    ...
    <Table>
        ...
        <TableBody>
            {
               allAppliedJobs.length <0 ?<span>You haven't not applied in any job yet. </span> : allAppliedJobs.map((appliedJob)=>(
                <TableRow key={appliedJob._id}>
                    <TableCell>{appliedJob?.jobcreatedAt?.split("T")[0]}</TableCell>
